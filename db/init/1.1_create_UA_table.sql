...
CREATE TABLE UA (
    ...
    type ENUM('EXPRESSO', 'VERDE', 'AZUL', 'NORMAL') NOT NULL,
    origin VARCHAR(255) NOT NULL,
    destination VARCHAR(255) NOT NULL,
    max_transfers INT DEFAULT 0,
...
('Teste Sistema 1', 'Teste 1', 'NORMAL', 'Porto', 'Faro', -1, '2025-12-19 18:00:00'),
('Teste Sistema 2', 'Teste 2', 'EXPRESSO', 'Porto', 'Faro', -1, '2025-12-19 18:00:00');
--('Teste Sistema 4', 'Teste 2', 'VERDE', 'Porto', 'Faro', -1, '2025-12-03 15:00:00')
--('Teste Sistema 4', 'Teste 2', 'NORMAL', 'Porto', 'Faro', -1, '2025-12-03 15:00:00')

--('Package Express Porto-Faro', 'High priority package for fastest delivery. No transfers specified.', 'EXPRESSO', 'Porto', 'Faro', -1, '2025-07-21 18:00:00'),
--('Package Green Porto-Faro', 'Environmentally conscious package, seeking lowest carbon emissions. No transfers specified.', 'VERDE', 'Porto', 'Faro', -1, '2025-07-21 18:00:00'),
--('Package Blue Porto-Faro', 'Priority package for fastest delivery. No transfers specified.', 'AZUL', 'Porto', 'Faro', -1, '2025-07-21 18:00:00'),
--('Package Normal Porto-Faro', 'Standard package delivery. No transfers specified.', 'NORMAL', 'Porto', 'Faro', -1, '2025-07-21 18:00:00');
