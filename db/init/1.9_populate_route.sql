...
-- Tempo: 10:00:00 - 18:00:00
INSERT INTO ROUTE_TEMPLATE (name, route_start_name, route_end_name, route_start_time, route_end_time, transport_id)
VALUES ('Porto-Faro', 'Porto', 'Faro', '10:00:00', '18:00:00', 3);
SET @route_id = LAST_INSERT_ID();
INSERT INTO SEQUENCE_TEMPLATE (id_template, sequence_order, item_type, item_id) VALUES
(@route_id, 1, 'stop', 1), -- Paragem de Início: Porto (G_P1)   - ID 1
(@route_id, 2, 'trip', 1), -- Viagem: Porto -> Faro             - ID 3
(@route_id, 3, 'stop', 2); -- Paragem de Fim: Faro (G_F1)       - ID 3

-- Rota 2: Porto -> Santarém -> Lisboa -> Faro
-- Tempo: 10:00:00 - 18:00:00
INSERT INTO ROUTE_TEMPLATE (name, route_start_name, route_end_name, route_start_time, route_end_time, transport_id)
VALUES ('Porto-Santarém-Lisboa-Faro', 'Porto', 'Faro', '12:00:00', '18:00:00', 3);
SET @route_id = LAST_INSERT_ID();
INSERT INTO SEQUENCE_TEMPLATE (id_template, sequence_order, item_type, item_id) VALUES
(@route_id, 1, 'stop', 3),  -- Paragem de Início: Porto (G_P2)  - ID 3
(@route_id, 2, 'trip', 2),  -- Viagem: Porto -> Santarém        - ID 2
(@route_id, 3, 'stop', 4),  -- Paragem: Santarém (G_S1)         - ID 4
(@route_id, 4, 'trip', 3),  -- Viagem: Santarém -> Lisboa       - ID 3
(@route_id, 5, 'stop', 5),  -- Paragem: Lisboa (G_L1)           - ID 4
(@route_id, 6, 'trip', 4),  -- Viagem: Lisboa -> Faro           - ID 3
(@route_id, 7, 'stop', 6);  -- Paragem de Fim: Faro (G_F2)      - ID 5

-- Rota 3: Porto -> Evora -> Faro
-- Tempo: 10:00:00 - 15:00:00
INSERT INTO ROUTE_TEMPLATE (name, route_start_name, route_end_name, route_start_time, route_end_time, transport_id)
VALUES ('Porto-Evora-Faro', 'Porto', 'Faro', '12:00:00', '18:00:00', 2);
SET @route_id = LAST_INSERT_ID();
INSERT INTO SEQUENCE_TEMPLATE (id_template, sequence_order, item_type, item_id) VALUES
(@route_id, 1, 'stop', 7), -- Paragem de Início: Porto (G_P3)   - ID 3
(@route_id, 2, 'trip', 5), -- Viagem : Porto -> Evora           - ID 1
(@route_id, 3, 'stop', 8), -- Paragem: Evora (G_E1)             - ID 1
(@route_id, 4, 'trip', 6), -- Viagem : Evora -> Faro            - ID 2
(@route_id, 5, 'stop', 9); -- Paragem de Fim: Faro (G_F1)       - ID 5
